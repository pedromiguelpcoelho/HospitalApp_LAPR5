describe('Update Operation Request', () => {
    ...
    it('should update an existing operation request', () => {
      ...
      cy.intercept('POST', '/api/OperationRequests/add', {
        ...
        body: {
          ...
          priority: 'Urgent',
          suggestedDeadline: '2024-12-01T12:00',
          message: 'Operation request created successfully',
        },
      }).as('createOperationRequest');
  
      // Step 1: Intercept the API call to fetch operation requests by doctor
      cy.intercept('GET', '/api/operationrequests/searchByDoctor', (req) => {
        ...
        const operationRequests = [
          ...
          },
          {
            ...
            priority: 'Elective',
            suggestedDeadline: '2024-12-02T12:00',
            requestDate: '2024-11-30T10:00'
          },
          {
            ...
            doctorName: 'Miguel Lima',
            priority: 'Emergency',
            suggestedDeadline: '2024-12-03T12:00',
            requestDate: '2024-11-30T10:00'
          },
          {
            ...
            doctorName: 'Sofia Paulo',
            priority: 'Urgent',
            suggestedDeadline: '2024-12-04T12:00',
            requestDate: '2024-11-30T10:00'
          }
        ];
      ...
      cy.intercept('PATCH', '/api/operationrequests/update/399af060-99d1-4e80-87d1-f2f0767f3f21', {
        statusCode: 200,
        body: {
          id: '399af060-99d1-4e80-87d1-f2f0767f3f21',
          patientName: 'Pedro Coelho',
          priority: 'Emergency',
          suggestedDeadline: '2024-12-30T10:00'
        }
      }).as('updateOperationRequest');
  
      // Step 3: Visit the home page and log in
      ...
      cy.get('input').click();
      cy.get('input').clear().type('2024-12-01T12:00');
      ...
      // Step 4: Navigate to the update operation request page
      cy.get(':nth-child(2) > ul > :nth-child(2) > .doctor-nav-item').click();
      cy.wait('@login');
      cy.wait('@getOperationRequestsByDoctor');
  
      // Step 5: Find the operation request and select it
      cy.get('select').select('399af060-99d1-4e80-87d1-f2f0767f3f21 - Pedro Coelho');
  
      // Step 6: Perform the update
      cy.get(':nth-child(2) > select').select('Urgent');
      cy.get('input').clear().type('2024-12-30T10:00');
      cy.get('.update-request-form > button').click();
      cy.wait('@updateOperationRequest');
  
      // Step 7: Verify the update
      cy.contains('Operation request updated successfully!').should('be.visible');
    });
  });