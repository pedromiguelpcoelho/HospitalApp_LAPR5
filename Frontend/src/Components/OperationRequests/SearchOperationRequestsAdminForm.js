...
const SearchOperationRequestsAdminForm = ({ onSearch }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        onSearch({ priority, doctorName, operationTypeName, patientName, expectedDueDate, requestDate });
    };
...
export default SearchOperationRequestsAdminForm;