...
// Author: Team 44
// Date: 2024-11-15
// Description: This class sets up and manages the hospital environment in a 
//              3D scene, including the floor, lights, fog, cameras, and user 
//              interface, using the three.js library.
// Adapted from: Basic_Thumb_Raiser (SGRAI) 
// ============================================================================

import * as THREE from "three";
import Orientation from "./Orientation.js";
import { generalData, hospitalFloorData, lightsData, fogData, cameraData } from "./default_data.js";
import { merge } from "./Merge.js";
import HospitalFloor from "./HospitalFloor.js";
...
export default class Floor {
    constructor(generalParameters, hospitalFloorParameters, lightsParameters, fogParameters, fixedViewCameraParameters, topViewCameraParameters) {
        this.generalParameters = merge({}, generalData, generalParameters);
        this.hospitalFloorParameters = merge({}, hospitalFloorData, hospitalFloorParameters);
        ...
        // Create a 3D scene (the hospital itself)
        this.scene3D = new THREE.Scene();

        // Create the hall
        this.hospitalFloor = new HospitalFloor(this.hospitalFloorParameters);
    ...
    update() {
        if (!this.gameRunning) {
            if (this.hospitalFloor.loaded) { 
                // Add the hall and the lights to the scene
                this.scene3D.add(this.hospitalFloor.object);
